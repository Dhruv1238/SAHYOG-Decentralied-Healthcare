...
const DropBox = ({ onFileDrop }) => {
    ...
    return (
        <Box {...getRootProps()} className="flex justify-center w-full shadow-xl h-[150px] cursor-pointer">
            <input {...getInputProps()} />
...
const Medical = () => {
    ...
    const handleDrop = (acceptedFiles) => {
        ...
        updateFormData({ ...form1, diagnostic_details: acceptedFiles[0] })
        navigate('/profile')
    }
    return (
